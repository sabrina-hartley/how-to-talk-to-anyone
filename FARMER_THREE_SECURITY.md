...
## They wanted proof. You gave them adjectives.
...
**Security through substance.** Their sense of safety comes from doing quality work, not from being seen doing work. Messages that connect to real output, measurable progress, and verified craft signal that you're operating on their level. Messages that float in the zone of "great vibes" and "awesome energy" signal that you're not tracking what actually matters.
...
2. **Style over substance.** "Let's make this look really impressive for the board." This undermines credibility. They don't want to make things *look* impressive—they want to make things *be* good. Prioritize craft quality and execution detail over appearance language.
...
5. **Time-wasting preamble.** "So I was thinking over the weekend, and I had this conversation with Sarah about how we might approach..." They're already scanning for the point. Every sentence that isn't the objective or the required output signals inefficiency and disrespect for their time. Start with the objective and the required output.
...
The left column sells. The right column builds. For this subtype, communication that sounds like a pitch triggers distrust. Communication that sounds like a production plan triggers engagement. They don't want to be inspired. They want to be deployed.
...
The leaders who learn to match their recognition to how each person actually processes it will retain their best performers. Everyone else will keep writing heartfelt notes that land as noise—and wondering why their top people keep leaving.

#### Your best people aren't motivated by your enthusiasm. They're motivated by your standards.
