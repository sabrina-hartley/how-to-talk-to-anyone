...
1. **Self-only bragging.** "I crushed this quarter" or leading with your individual metrics. This breaks the ally orientation of someone who defines achievement through the people they elevate. Highlight collective wins and the specific individuals who contributed: "This result reflects the work of three teams, especially the partner group you built."

2. **Cold data dump.** Charts, tables, and bullet points with no human context. This misses the relational motivation entirely—numbers without narrative are inert to someone who processes achievement through people. Pair every metric with a human impact story: "Conversions up 40%, driven by the advocacy program that spotlighted our client partners."

3. **Abstract vision only.** "We're building the future of customer engagement." Inspiring, maybe, but a Hunter Three needs to see the execution layer. Who's doing what, by when, and what tangible outcomes does it create for the people involved? Attach concrete deliverables and dates to every aspirational statement.

4. **Detached tone.** "Per the attached analysis, the recommended action is..." This reads like a filing cabinet, not a person. Use engaged, personal language with clear purpose: "I put this together because I think it makes a strong case for expanding your partner program—here's why."
...
**This is Part 9 of a 27-part series on subtype-specific communication.**

| | | |
|---|---|---|
| [![](./img/thumbs/teamer-three-prestige.png)](./TEAMER_THREE_PRESTIGE.md) | Previous | [Teamer Three: Prestige](./TEAMER_THREE_PRESTIGE.md) |
| [![](./img/thumbs/farmer-four-tenacity.png)](./FARMER_FOUR_TENACITY.md) | Next | [Farmer Four: Tenacity](./FARMER_FOUR_TENACITY.md) |
