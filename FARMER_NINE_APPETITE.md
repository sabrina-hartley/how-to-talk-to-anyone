...
**Comfort-merged attention.** Their focus naturally flows toward the familiar, the routine, and the physically present. This isn't avoidance — it's gravitational. New requests need to attach to existing habits or they float away. When you ask them to "start fresh" on something abstract, you're fighting gravity. When you say "after your 10 AM standup, do this one thing," you're using it.

**Concrete over abstract.** They process the world through tangible, everyday actions — not strategic visions or long-term frameworks. "Think about Q3 priorities" is vapor. "Open the spreadsheet and fill in row one" is a task. The gap between those two sentences is the gap between action and inertia. They don't lack capability. They lack traction on anything that doesn't have a physical, immediate shape.

**Low-friction momentum.** Once they're moving, they keep moving. The challenge is always the start. Anything that creates internal friction — urgency spikes, conflict framing, too many choices, emotional intensity — triggers a subtle but powerful shutdown. Not defiance. Just... stillness. The message gets acknowledged, mentally filed, and gently buried under whatever's already happening. Your job is to make starting easier than not starting.
...
5. **Vague asks with no first step.** "Please make progress on this soon." Progress how? Starting where? At what time? Vague asks are an open invitation to procrastinate, because "soon" always means "after I finish what I'm already doing." State the exact first step and the exact time to do it. That's not micromanaging — that's traction.
...
The managers who learn to match their requests to each person's momentum style will get consistent follow-through from people everyone else has written off as "slow." The difference isn't the person. It's whether you gave them a starting point or a void.

#### They're not ignoring you. They're waiting for a task shaped like something they can actually do — right now, with what's already in front of them.
