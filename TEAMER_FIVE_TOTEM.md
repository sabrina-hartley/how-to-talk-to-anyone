...
1. **Shallow slogans.** "Let's move the needle" or "drive impact." This feels intellectually empty to someone who processes the world through conceptual models. Replace slogans with defined concepts and reasoning. State the thesis directly.

2. **Purely teamer appeal.** "The team is counting on you" or "do it for the group." This misses their entire value framework. Teamer Fives engage through shared mission and knowledge. Anchor the request to meaning and intellectual purpose.
...
4. **Anti-intellectual brevity.** "Just do X." The removal of substance is the problem. Teamer Fives respect efficiency, but they need to see that the thinking happened before the compression. Compress without removing substance: show the model, then give the shorthand.
