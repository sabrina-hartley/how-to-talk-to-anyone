...
1. **Timid framing.** "I hope we can find a way through this." Hope is not a strategy, and to this person it signals that you haven't prepared one. Signal competence and resolve immediately by naming the threat, your response, and the timeline.
...
4. **Appeasing aggressors.** "Let's not rock the boat—we can work around the issue." Accommodation reads as capitulation, so set boundaries explicitly, name the consequences of crossing them, and show you'll hold the line.

5. **Delayed decision loops.** "Let's circle back after we've had more time to think." More time to think means more time exposed, so time-box decisions by stating when the decision window closes and what happens when it does.
