...
**Counter-phobic readiness.** This Six doesn't retreat from fear—they charge at it. That's not bravery for its own sake; it's a survival mechanism. When they hear "let's stay calm," they don't hear wisdom. They hear someone who hasn't acknowledged the severity of the threat. Your communication needs to match their threat awareness or it gets dismissed as naive.

**Competence as trust signal.** They don't trust charm, optimism, or positional authority. They trust demonstrated capability. Showing that you've war-gamed the scenarios, know the failure modes, and have contingencies ready earns their respect faster than any amount of rapport-building. If you can't speak to the worst case with specifics, you're not someone they'll follow.

**Decisive defensive posture.** Hesitation is a red flag. Open-ended exploration is a red flag. "Let's see how things develop" is a red flag. They need to know the trigger points, the response plan, and the chain of command—before they need them. Speed and clarity of response aren't preferences. They're the metric by which they judge whether you're safe to work with.

### 5 ways you're losing them before you start

1. **Timid framing.** "I hope we can find a way through this." Hope is not a strategy, and to this person it signals that you haven't prepared one. Signal competence and resolve immediately. Name the threat, name your response, name the timeline.

2. **Empty bravado.** "Don't worry, we've got this handled." Confidence without evidence looks reckless and unprepared to them. Back every confident statement with concrete readiness details—who's trained, what's tested, what's the fallback.

3. **Unclear defense plan.** "We'll figure out the contingencies as we go." You just told them there's no contingency plan. Define the command structure, the trigger points, and the specific responses for each scenario before you present.

4. **Appeasing aggressors.** "Let's not rock the boat—we can work around the issue." Accommodation reads as capitulation. Set boundaries explicitly. Name the consequences of crossing them. Show that you'll hold the line, not just hope the line holds itself.

5. **Delayed decision loops.** "Let's circle back after we've had more time to think." More time to think means more time exposed. Time-box decisions. State when the decision window closes and what happens when it does.
...
The pattern: replace calm with competence. Replace hope with readiness. Replace open-ended timelines with trigger-based action plans. They don't need you to be fearless. They need you to be prepared—and willing to prove it.
...
The communicators who learn to signal readiness to the people who scan for it—and signal something entirely different to those who don't—will earn trust that survives pressure. Everyone else will keep presenting solid plans and watching them get dismissed by someone who needed a war footing, not a slide deck.
